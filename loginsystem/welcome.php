...
<body>
    ...
    <div class="container">
        <header class="jumbotron hero-spacer">
			...
			Das Datum steht noch nicht fest. Um über die Ausschreibung informiert zu werden, schaue in unserer Eventliste nach.
            </p>
        </header>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i>Hier findes du Informationen über alle aktiven Mitglieder </h4>
	                  	  	  <hr>
                              <thead>
                              <tr>
                                  <th>Sno.</th>
                          ...
                          </table> <p><a  href="welcome.php" class="btn btn-primary btn-large">refresh </a>
                      </div>
                  </div>
              </div>
		</section>
